...
{
public:
	DoorAnimationMsg(uint32 doorId,uint16 viewId)
	{
		// Generated by BreakPoint Software's Hex Workshop v6.0.1.4603
		//   http://www.hexworkshop.com
		//   http://www.bpsoft.com
		//
		//  Source File: Untitled26
		//         Time: 24.2.2010 2:19
		// Orig. Offset: 0 / 0x00000000
		//       Length: 54 / 0x00000036 (bytes)
		unsigned char rawData[54] =
		{
			0x03, 0x01, 0x00, 0x08, 0xDA, 0x19, 0xBB, 0xBB, 0xBB, 0xBB, 0xB9, 0xCD, 0xAB, 0x02, 0x80, 0x41, 
			0x00, 0x00, 0x00, 0x00, 0x20, 0x92, 0x06, 0x41, 0x00, 0x00, 0x00, 0x00, 0x00, 0xB8, 0x8A, 0xC0, 
			0x00, 0x00, 0x00, 0x00, 0x00, 0x83, 0xE8, 0x40, 0x34, 0x08, 0x00, 0x00, 0x08, 0x00, 0x00, 0x03, 
			0x00, 0x01, 0x02, 0x73, 0x00, 0x00, 
		} ;
